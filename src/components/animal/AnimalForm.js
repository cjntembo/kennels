    ...
    <form className="animalForm">
      ...
      <fieldset>
         <div className="form-group">
           ...
           <input type="text" id="breed" name="breed" required autoFocus className="form-control" placeholder="Animal breed" defaultValue={animal.breed} onChange={handleControlledInputChange} />
         </div>
      </fieldset>
      <fieldset>
        <div className="form-group">
...
// Below is everything before chap 12 book 6
// export const AnimalForm = () => {
